...
class LoginViewController: BaseViewController {
    ...
    override func setUpView() {
        ...
        phontTextField.reactive.continuousTextValues.observeValues { (action) in
            ...
            if self.senderCode != nil {
                if self.loginForm.phone.length == 11 {
                    ...
                    self.senderCode.backgroundColor = UIColor.init(hexString: App_Theme_F94856_Color)
                }else{
        ...
        comfigLabel.textColor = UIColor.init(hexString: App_Theme_A0A0A0_Color)
...
//        self.view.addSubview(proBtn)
    ...
    func createLabel(_ frame:CGRect, text:String) ->UILabel {
        ...
        label.textColor = UIColor.init(hexString: App_Theme_A0A0A0_Color)
    ...
    func createTextFiled(_ frame:CGRect) -> UITextField {
        ...
        textField.tintColor = UIColor.init(hexString: App_Theme_F94856_Color)
        return textField
    }
